      ...
      <div id="page">
        ...
        <section id="body" className="container" >
          <div className="row hidden-xs">
            ...
            <img src="./images/carousel-2.jpg" alt="2" className="col-md-2 col-sm-2" />
            <img src="./images/carousel-3.jpg" alt="3" className="col-md-2 col-sm-2" />
            <img src="./images/carousel-4.jpg" alt="4" className="col-md-2 col-sm-2" />
          </div>
          <section id="main" className="col-md-8 col-sm-9">
            ...
            <img src="./images/lebowski-1.jpg" alt="Bowling" className="center-block img-thumbnail" />
            ...
            <img src="./images/lebowski-3.jpg" alt="Rug" className="center-block img-thumbnail" />
